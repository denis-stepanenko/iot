        ...
        scales: {
          ...
          x: {
            ...
            time: {
              parser: 'hh:mm:ss',
              unit: 'hour',
              tooltipFormat: 'MMMM DD, HH:mm:ss',
              displayFormats: {
                hour: 'HH:mm:ss',
              },
            },
    ...
    <React.Fragment>
      <div className="px-5 py-3">
        <div className="flex items-start">
          ...
          <div className="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2 tabular-nums"><span ref={chartValue}></span></div>
          <div ref={chartDeviation} className="text-sm font-medium px-1.5 rounded-full" hidden={data.datasets[0].data[data.datasets[0].data.length - 2] === undefined}></div>
        </div>
      </div>
      <div className="grow">
