...
export default function NewIndicator({ items, onAdd }) {
  ...
  return (
    <>
      <Button variant="text" onClick={handleClickOpen}>Добавить индикатор</Button>
      ...
      <Dialog
        ...
        PaperProps={{
          ...
          onSubmit: (event) => {
            ...
            if (!hasErrors) {
              onAdd({ $type: 'indicator', title: name, topic: topic, value: 0, subscribed: false, readings: [] });
      ...
      >
        <DialogTitle>Новый индикатор</DialogTitle>
        <DialogContent>
